...
public class ChangePassClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commandOutput = "Select-Username ".concat(commandOutput);
    ...
    public void connectClicked(View view) {
        ...
        Spinner spinner = (Spinner) findViewById(R.id.ulist);
        EditText text = (EditText)findViewById(R.id.newpass);
        String value = text.getText().toString();
        EditText text2 = (EditText)findViewById(R.id.renewpass);
        String value2 = text2.getText().toString();
        if(value.equals(value2)){
            String commandOutput = exec.startConnection(ServerInstance.getInstance(),"echo '"+value+":"+spinner.getSelectedItem().toString()+"' | chpasswd" );
